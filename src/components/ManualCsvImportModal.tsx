                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="modal-body modal-body-spacing">
                            <p className="help-text" style={{ fontSize: '0.78rem', color: 'var(--text-secondary)', margin: 0 }}>
                                {userRole !== 'member'
                                    ...
                                    : t('csv_input_desc_member')}
                            </p>
                            <div className="form-group" style={{ margin: 0 }}>
                                <textarea
                                    id="csvInputModalText"
                                    placeholder={userRole !== 'member' ? t('csv_input_placeholder_officer') : t('csv_input_placeholder_member')}
                                    value={csvText}
                                    ...
                                    style={{
                                        ...
                                        opacity: userRole === 'member' ? 0.6 : 1,
                                        cursor: userRole === 'member' ? 'not-allowed' : 'text'
                                    }}
                                />
                            </div>
                        </div>
                        <div className="modal-footer">
                            ...
                            <button 
                                ...
                                disabled={userRole === 'member'}
                                style={userRole === 'member' ? { opacity: 0.5, cursor: 'not-allowed' } : {}}
                            >
                                {t('import_stock')}
                            </button>
                        </div>
