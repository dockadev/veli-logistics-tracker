...
export const de: Partial<Record<keyof typeof en, string>> = {
    ...
    supabase_not_configured: "Serververbindung nicht verfügbar. Die App kann ohne Supabase-Konfiguration nicht ausgeführt werden.",
    ...
    mpf_cost_warning: "Hinweis: Die Bedarfsdaten der aufgeführten Gegenstände sind korrekt; die MPF-Kosten jedes Gegenstands können jedoch falsch berechnet sein.",
    ...
    show_more_cities: "Mehr anzeigen",
    show_less_cities: "Weniger anzeigen",
    ...
    how_direct_sync_step2_title: "2. Intervall festlegen & Aufnahme starten",
    how_direct_sync_step3_title: "3. Akustische Bestätigung & Lager-Synchronisierung",
    how_direct_sync_step1_title: "1. Vorräte im Spiel anheften und aktualisieren",
    how_direct_sync_works_title: "So funktioniert die direkte .SAV-Synchronisierung",
    how_direct_sync_step3_desc: "Bei der Synchronisierung ertönt ein Signalton. Bestehende Lager werden automatisch aktualisiert; neu gescannte Lager können von Offizieren über die Registerkarte 'Stockpile Management' hinzugefügt werden.",
    how_direct_sync_step1_desc: "Pinnen Sie Ihre Vorräte und Seehäfen auf der Foxhole-Karte im Spiel (M), um aktualisierte Tooltip-Daten in Ihre lokale Speicherdatei zu schreiben.",
    how_direct_sync_step2_desc: "Wählen Sie das gewünschte Intervall und klicken Sie auf 'Aufnahme starten', um die Überwachung zu beginnen.",
    please_read_first: "BITTE ZUERST LESEN",
    pin_duration: "Pin-Dauer (oberes Banner)",
    pin_none: "Kein Pin",
    pin_6h: "6 Stunden",
    pin_12h: "12 Stunden",
    pin_1d: "1 Tag",
    ...
    pin_3d: "3 Tage",
    pin_1w: "1 Woche",
    pinned_badge: "GEPINNT",
    pinned_until: "Angepinnt bis {time}",
    pinned_cannot_dismiss: "Angepinnte Ankündigung (Kann nicht geschlossen werden)",
    hero_tracker: "Tracker",
    hero_logistics: "Logistik",
    remember_me: "Erinnere dich an mich",
    login_panel_title: "Login-Panel",
    needed: "Benötigt",
    ads_space: "Diese Fläche steht für Werbung zur Verfügung",
    pinned_announcements: "Angepinnte Ankündigungen",
    no_announcements: "Noch keine Ankündigungen",
    unpin: "Lösen",
    unpin_announcement: "Ankündigung lösen",
    pin: "Anpinnen:",
