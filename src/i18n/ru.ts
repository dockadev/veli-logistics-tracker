...
export const ru: Partial<Record<keyof typeof en, string>> = {
    ...
    supabase_not_configured: "Подключение к серверу недоступно. Приложение не может работать без настройки Supabase.",
    ...
    mpf_cost_warning: "Примечание: данные о потребностях указанных предметов верны; однако стоимость MPF для каждого предмета может быть рассчитана неверно.",
    ...
    show_more_cities: "Показать больше",
    show_less_cities: "Показать меньше",
    ...
    target: "Цель",
    current: "Текущий",
    hero_logistics: "Логистика",
    login_panel_title: "Панель входа",
    hero_tracker: "Трекер",
    remember_me: "Запомнить меня",
    needed: "Нужный",
    ads_space: "Это место доступно для рекламы",
    pinned_announcements: "Закрепленные объявления",
    no_announcements: "Объявлений пока нет",
    unpin: "Открепить",
    unpin_announcement: "Открепить объявление",
    pin: "Закрепить:",
